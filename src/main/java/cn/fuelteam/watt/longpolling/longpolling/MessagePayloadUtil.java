...
public class MessagePayloadUtil {
    ...
    private List<MessagePayload> deserialisePayloadList(final String sourceJson) {
        try {
            ...
            return objectMapper.readValue(sourceJson,
                    objectMapper.getTypeFactory().constructCollectionType(List.class, MessagePayload.class));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public String getMessagePayload() {
        try {
            ...
            messagePayload.add(deserialisePayload(
                    new ObjectMapper().writerWithDefaultPrettyPrinter().writeValueAsString(new MessagePayload())));
